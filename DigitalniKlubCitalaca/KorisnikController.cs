...
namespace DigitalniKlubCitalaca
{
    public class KorisnikController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("KorisnikId,Ime,Prezime,Email,Lozinka,ProfilnaSlika,Biografija,LokacijaX,LokacijaY,Uloga,StatusNaloga")] Korisnik korisnik)
        {
